...
public class PooledDataSource {
	...
	public final static Logger logger = LogManager.getLogger(org.tfelab.db.PooledDataSource.class.getName());
	...
	public static synchronized ComboPooledDataSource addDataSource(String dbName) throws Exception{
		...
		try {
			...
			Config config = Configs.getConfig(org.tfelab.db.PooledDataSource.class).getConfig(dbName);
