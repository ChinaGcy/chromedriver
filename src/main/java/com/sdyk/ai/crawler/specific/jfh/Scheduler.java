package com.sdyk.ai.crawler.specific.jfh;

import com.google.common.collect.ImmutableMap;
import com.sdyk.ai.crawler.HttpTaskPoster;
import com.sdyk.ai.crawler.specific.jfh.action.JfhLoginAction;
import com.sdyk.ai.crawler.specific.jfh.task.JfhLoginTask;
import com.sdyk.ai.crawler.specific.jfh.task.scanTask.ProjectScanTask;
import com.sdyk.ai.crawler.specific.jfh.task.scanTask.ServiceScanTask;
...
public class Scheduler extends com.sdyk.ai.crawler.Scheduler {
	...
	public void getLoginTask(ChromeDriverAgent agent, Account account) throws MalformedURLException, URISyntaxException, ChromeDriverException.IllegalStatusException, InterruptedException {
		...
		agent.submit(new ChromeTask("https://passport.clouderwork.com/signin").addAction(new JfhLoginAction(account)));
	...
	public static void main(String[] args) {
		...
		Scheduler scheduler = new Scheduler("jfh", num);
