package com.sdyk.ai.crawler.specific.oschina;

import com.google.common.collect.ImmutableMap;
import com.sdyk.ai.crawler.HttpTaskPoster;
import com.sdyk.ai.crawler.specific.oschina.action.OschinaLoginAction;
import com.sdyk.ai.crawler.specific.oschina.task.scanTask.ProjectScanTask;
...
public class Scheduler extends com.sdyk.ai.crawler.Scheduler {
	...
	public static void main(String[] args) {
		...
		Scheduler scheduler = new Scheduler("oschina", num);
