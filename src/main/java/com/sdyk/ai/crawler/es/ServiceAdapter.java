...
public class ServiceAdapter {
	...
	public static Map<String, Object> serviceQuery(Map map, String query, int page, int length) throws Exception {
		...
		SearchResponse response =
				ESTransportClientAdapter.getClient()
						...
						.setQuery((QueryBuilder) newQueryByService(map, query))
						.setFrom(from)
						.setSize(length)
						.setExplain(false)
						.get();
	...
	private static Object newQueryByService (Map<String ,String> map, String query) {
